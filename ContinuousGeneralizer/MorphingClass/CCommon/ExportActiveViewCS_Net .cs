...
{
    public class ExportActiveViewCS_Net
    {
            ...
            string ExportType, string sOutputDir, Boolean bClipToGraphicsExtent)
        {
            ...
            docActiveView.Extent.XMin = -15;
            docActiveView.Extent.YMin = -15;
            docActiveView.Extent.XMax = 320;
            docActiveView.Extent.YMax = 520;
            docActiveView.FullExtent = pExtent;
            docActiveView.Extent = pExtent;
