...
namespace MorphingClass.CMorphingMethods
{
    public class CMPBDP
    {
        ...
        ///// <remarks>DWByDP:DealWithByDP
        ///// 本方法主要用于外部对DP算法的调用</remarks>
        //public C5.LinkedList<CCorrSegment> DWByDPDefine(CPolyline frcpl, CPolyline tocpl, CParameterThreshold ParameterThreshold)
        //{
        //    if (frcpl.pPolyline.Length == 0 || tocpl.pPolyline.Length == 0)
        //    {
        ...
        //public void SubPolylineMatch(CPolyline CFrPolyline, CPolyline CToPolyline, CParameterThreshold ParameterThreshold, ref C5.LinkedList<CCorrSegment> CorrespondSegmentLk)
        //{
