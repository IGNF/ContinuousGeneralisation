...
namespace MorphingClass.CMorphingMethods
{
    public class CMPBDPBL
    {
        ...
        ///// 本方法主要用于外部对DP算法的调用</remarks>
        //public C5.LinkedList<CCorrSegment> DWByDPLDefine(CPolyline frcpl, CPolyline tocpl, CParameterThreshold ParameterThreshold)
        //{
        //    //if (frcpl.pPolyline.Length == 0 || tocpl.pPolyline.Length == 0)
        //    //{
        //    //    C5.LinkedList<CCorrSegment> CorrespondSegmentLk00 = new C5.LinkedList<CCorrSegment>();
        ...
        ///// 本方法主要用于外部对DP算法的调用</remarks>
        //public C5.LinkedList<CCorrSegment> DWByDPLADefine(CPolyline frcpl, CPolyline tocpl, CParameterThreshold ParameterThreshold)
        //{
        //    //if (frcpl.pPolyline.Length == 0 || tocpl.pPolyline.Length == 0)
        //    //{
        //    //    C5.LinkedList<CCorrSegment> CorrespondSegmentLk00 = new C5.LinkedList<CCorrSegment>();
        ...
        ///// <remarks>DWByDP:DealWithByDP
        ///// 本方法主要用于外部对DP算法的调用</remarks>
        //public C5.LinkedList<CCorrSegment> DWByDPDefine(CPolyline frcpl, CPolyline tocpl, double dblBound)
        //{
        //    //if (frcpl.pPolyline.Length == 0 || tocpl.pPolyline.Length == 0)
        //    //{
        //    //    C5.LinkedList<CCorrSegment> CorrespondSegmentLk00 = new C5.LinkedList<CCorrSegment>();
        ...
        //public void SubPolylineMatchLA(CPolyline frcpl, CVirtualPolyline vfrcpl, CPolyline tocpl, CVirtualPolyline vtocpl, CParameterThreshold ParameterThreshold, ref C5.LinkedList<CCorrSegment> CorrespondSegmentLk)
        //{
        ...
        //public void SubPolylineMatchL(CPolyline CFrPolyline, CPolyline CToPolyline, CParameterThreshold ParameterThreshold, ref C5.LinkedList<CCorrSegment> CorrespondSegmentLk)
        //{
        //    //如果其中一个线段没有孩子，则直接匹配并结束
        //    if (CFrPolyline.CLeftPolyline == null || CToPolyline.CLeftPolyline == null)
        //    {
        //        CCorrSegment CorrespondSegment = new CCorrSegment(CFrPolyline, CToPolyline);
        //        CorrespondSegmentLk.Add(CorrespondSegment);
        //        return;
        //    }
