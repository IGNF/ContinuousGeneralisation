...
namespace MorphingClass.CMorphingMethods
{
    ...
    public class CBSBLGOptCorMM
    {
        ...
        public void BSBLGOptCorMMMorphing()
        {
            ...
            //C5.LinkedList<CCorrSegment> BSCorrespondSegmentLk = new C5.LinkedList<CCorrSegment>();
            ...
            //C5.LinkedList<CCorrSegment> OptCorMMCorrespondSegmentLk = new C5.LinkedList<CCorrSegment>();
