...
namespace MorphingClass.CMorphingMethods
{
    ...
    public class CMPMBS
    {
        ...
        public void MPBBSLMorphing()
        {
            ...
            //    //提取对应线段
            //    C5.LinkedList<CCorrespondSegment> CorrespondSegmentLk = DetectCorrespondSegment(frcpl, tocpl, CorrespondBendLt);
            ...
            ////提取对应线段
            //C5.LinkedList<CCorrespondSegment> pCorrespondSegmentLk = DetectCorrespondSegment(frcpl, tocpl, pCorrespondBendLt);
