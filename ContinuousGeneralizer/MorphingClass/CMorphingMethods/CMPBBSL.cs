...
namespace MorphingClass.CMorphingMethods
{
    ...
    public class CMPBBSL
    {
        ...
        {          
            ...
            //    ////提取对应线段
            //    //C5.LinkedList<CCorrSegment> CorrespondSegmentLk = CHelpFunc.DetectCorrespondSegment(frcpl, tocpl, CorrespondBendLt);
            ...
            ////提取对应线段
            //LinkedList<CCorrSegment> pCorrespondSegmentLk = CHelpFunc.DetectCorrespondSegment(frcpl, tocpl, pCorrespondBendLt);
