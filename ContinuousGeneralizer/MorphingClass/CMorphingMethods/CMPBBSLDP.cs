...
namespace MorphingClass.CMorphingMethods
{
    ...
    public class CMPBBSLDP
    {
        ...
        public void MPBBSLDPMorphing()
        {
            ...
            //    //提取对应线段
            //    //C5.LinkedList<CCorrSegment> BSCorrespondSegmentLk = CHelpFunc.DetectCorrespondSegment(frcpl, tocpl, CorrespondBendLt);

            //    //**************BLG树处理过程**************//
            //    //经过BLG树处理后的最终对应线段                
            //    //C5.LinkedList<CCorrSegment> BLGCorrespondSegmentLk = new C5.LinkedList<CCorrSegment>();
            ...
            ////提取对应线段
            //C5.LinkedList<CCorrSegment> pBSCorrespondSegmentLk = CHelpFunc.DetectCorrespondSegment(frcpl, tocpl, pCorrespondBendLt);
