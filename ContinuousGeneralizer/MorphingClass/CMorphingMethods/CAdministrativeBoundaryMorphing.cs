...
namespace MorphingClass.CMorphingMethods
{
    ...
    public class CAtBdMorphing
    {
        ...
        //public void SubPolylineMatchLA(CPolyline CFrPolyline, CVirtualPolyline CFrVtPl, CPolyline CToPolyline, CVirtualPolyline CToVtPl, CParameterThreshold ParameterThreshold, ref C5.LinkedList<CCorrespondSegment> CorrespondSegmentLk)
        //{
