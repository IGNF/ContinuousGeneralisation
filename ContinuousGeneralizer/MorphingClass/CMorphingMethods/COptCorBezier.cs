...
namespace MorphingClass.CMorphingMethods
{
    ...
    public class COptCorBezier
    {
        ...
        public void OptCorBezierMorphing()
        {
            ...
            //C5.LinkedList<CCorrSegment> pCorrespondSegmentLk = FindCorrespondSegmentLk(T, frcpl, tocpl, CFrBezierEdgeLt, CToBezierEdgeLt, frlastcpllt, tolastcpllt);            
        ...
        public void OptCorBezierMultiResultsMorphing()
        {
            ...
            //    LinkedList<CCorrSegment> pCorrespondSegmentLk = FindCorrespondSegmentLk(T, frcpl, tocpl, CFrBezierEdgeLt, CToBezierEdgeLt, frlastcpllt, tolastcpllt);
        ...
        public LinkedList<CCorrSegment> DWByOptCorBezier(CPolyline frcpl, CPolyline tocpl, List<CPolyline> CFrEdgeLt, List<CPolyline> CToEdgeLt, int intMaxBackK)
        {
            ...
            LinkedList<CCorrSegment> pCorrespondSegmentLk = FindCorrespondSegmentLk(T, frcpl, tocpl, CFrEdgeLt, CToEdgeLt, frlastcpllt, tolastcpllt);
