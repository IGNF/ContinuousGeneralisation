...
namespace MorphingClass.CCorrepondObjects
{
    ...
    public class CCorrCpts
    {
        ...
        public CPoint GetInterpolatedCpt(double dblProp)
        {
            return CGeoFunc.GetInterpolatedCpt(this.FrCpt, this.pMoveVector, dblProp);
        }

        public IPoint GetInterpolatedIpt(double dblProp)
        {
            return CGeoFunc.GetInterpolatedIpt(this.FrCpt, this.pMoveVector, dblProp);
        }
