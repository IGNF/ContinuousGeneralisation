...
{
    public class CCorrespondSegment
    {
        ...
        public CCorrespondSegment()
        {

        }

        public CCorrespondSegment(CBend FrBend, CBend TBend)
        {
        ...
        public CCorrespondSegment(List<CPoint> frptlt, List<CPoint> tptlt)
        {
            //_CFromPtLt = frptlt;
            //_CToPtLt = tptlt;
        ...
        public CCorrespondSegment(CPolyline frpl, CPolyline topl)
        {
            //_CFromPtLt = frptlt;
            //_CToPtLt = tptlt;
