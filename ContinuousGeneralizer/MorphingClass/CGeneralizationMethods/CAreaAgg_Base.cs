...
namespace MorphingClass.CGeneralizationMethods
{
    public class CAreaAgg_Base : CMorphingBaseCpg
    {
        ...
        pstrFieldNameLt, pesriFieldTypeLt, pobjectValueLtLt, strSymbolLayerPath: pParameterInitialize.strMxdPathBackSlash + "complete.lyr");
        }
        ...
        public static void SaveData(CStrObjLtSD StrObjLtSD, CParameterInitialize pParameterInitialize, string strMethod, int intQuitCount)
        {
            ...
            ExportForLatex(objDataLtSS, CAreaAgg_AStar.strKeyLt, pParameterInitialize.strSavePath);
