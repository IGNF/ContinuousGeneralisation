...
namespace MorphingClass.CMorphingAlgorithms
{
    public class CAlgorithmsHelper
    {
        ...
        public List<CPoint> BuildPointCorrespondence(LinkedList<CCorrSegment> CorrespondSegmentLk, string strCorrType)
        {            
        ...
        /// <returns>点数组</returns>
        private List<CPoint> ByLinear(LinkedList<CCorrSegment> CorrespondSegmentLk)
        {
            int intCount = 1;
