...
namespace MorphingClass.CGeometry
{
    public class CPoint : CGeoBase
    {
        ...
        public CPoint Move(double dblMoveX, double dblMoveY, double dblMoveZ = 0)
        {
            return new CPoint(this.ID, this.X + dblMoveX, this.Y + dblMoveY, this.Z + dblMoveZ);
        }
