...
{
    public class CPolyBase: CLineBase
    {
        ...
        {
            SetCpbAngleDiffLt(this as CPolyBase);
        }
        ...
        {
           return this.CptLt.Min(cpt => cpt.X);
        }

        public double GetMaxX()
        {
            return this.CptLt.Max(cpt => cpt.X);
        }

        public double GetMinY()
        {
            return this.CptLt.Min(cpt => cpt.Y);
        }

        public double GetMaxY()
        {
            return this.CptLt.Max(cpt => cpt.Y);
        }
        ...
        {
            return (this.GetMinY() + this.GetMaxY()) / 2;
        }
