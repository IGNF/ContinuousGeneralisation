...
namespace MorphingClass.CUtility
{
    public static class CHelpFuncExcel
    {
        ...
        public static void ExportEvaluationToExcelCorr(CParameterResult pParameterResult, string strPath, string strSuffix = null)
        {
            ...
            {
                string strEntireFileName = strPath + "\\" + strfilename + strEvaluationMethod + CHelpFunc.JudgeAndAddZero(i, 4) + "__" + dblSumEvaluationLtLt[i].GetLastT().ToString();
            ...
            {
                dblSumEvaluationLt.Add(dblSumEvaluationLtLt[i].GetLastT());
            }
