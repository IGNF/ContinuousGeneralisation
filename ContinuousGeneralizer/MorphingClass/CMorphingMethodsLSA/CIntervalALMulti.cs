...
namespace MorphingClass.CMorphingMethodsLSA
{
    ...
    public class CIntervalALMulti
    {
        ...
        public CIntervalALMulti()
        {

        }

        public CIntervalALMulti(CDataRecords pDataRecords, double dblTX)
        {
            _DataRecords = pDataRecords;
            _dblTX = dblTX;
        }

        public CIntervalALMulti(CDataRecords pDataRecords)
        {
            _DataRecords = pDataRecords;
        ...
        public void IntervalALMultiMorphing()
        {
        ...
        public List<CPolyline> GetTargetcpllt()
        {
            ...
            for (int k = 0; k < 2; k++)
            {
                ...
                do
                {
                    ...
                    //CHelperFunctionExcel.ExportDataToExcel2(matl, "matl", _DataRecords.ParameterInitialize.strSavePath);
                    ...
                    CHelperFunctionExcel.ExportDataToExcel2(x, "matx", _DataRecords.ParameterInitialize.strSavePath);
