...
namespace MorphingClass.CMorphingMethodsLSA
{
    ...
    public class CALL
    {
        ...
        public CALL(CDataRecords pDataRecords, double dblTX)
        {
        ...
        public CALL(CDataRecords pDataRecords)
        {
            _DataRecords = pDataRecords;
        ...
        public CPolyline GetTargetcpl(double dblProp, CPolyline lastcpl)
        {
            ...
            {
                P[intUnknownLength + i, intUnknownLength + i] = 200;
            }
            for (int i = 0; i < intUnknownPt; i++)
            {
                P[intUnknownLengthAngle + i, intUnknownLengthAngle + i] = 0.0000001;
            }
