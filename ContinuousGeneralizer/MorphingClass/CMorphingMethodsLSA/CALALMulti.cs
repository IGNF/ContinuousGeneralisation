    ...
    public class CALALMulti
    {
        ...
        public List<CPolyline> GetTargetcpllt()
        {
            ...
            for (int i = 0; i < intInterNum; i++)
            {
                ...
                {
                    X0[intPreMultiXYNum + 2 * j + 0, 0] = (1 - dblProp) * pCorrCptsLt[j].FrCpt.X + dblProp * pCorrCptsLt[j].ToCpt.X;
                    X0[intPreMultiXYNum + 2 * j + 1, 0] = (1 - dblProp) * pCorrCptsLt[j].FrCpt.Y + dblProp * pCorrCptsLt[j].ToCpt.Y;
                }
            }
            ...
            for (int k = 0; k < 100; k++)
            {
                ...
                do
                {
                    ...
                    double dblLength = CGeoFunc.CalLengthofVector(x);
