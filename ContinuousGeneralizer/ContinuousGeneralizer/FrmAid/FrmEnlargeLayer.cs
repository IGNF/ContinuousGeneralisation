...
{
    public partial class FrmEnlargeLayer : Form
    {
        ...
        public FrmEnlargeLayer(CDataRecords pDataRecords)
        {
            InitializeComponent();
        ...
        private void FrmEnlargeLayer_Load(object sender, EventArgs e)
        {
        ...
        public void btnRun_Click(object sender, EventArgs e)
        {
            ...
            //double dblEnlargementFactor = Convert.ToDouble(this.txtEnlargementFactor.Text);
