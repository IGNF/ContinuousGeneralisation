...
{
    public partial class FrmMatchAndMergePolylines : Form
    {
        ...
        public FrmMatchAndMergePolylines()
        {
            InitializeComponent();
        }
        ...
        public FrmMatchAndMergePolylines(CDataRecords pDataRecords)
        {
            InitializeComponent();
        ...
        private void FrmMatchAndMergePolylines_Load(object sender, EventArgs e)
        {
