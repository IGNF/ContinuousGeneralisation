...
namespace ContinuousGeneralizer
{
    public partial class FrmContinuousGeneralizer : Form
    {
        ...
        private void frmContinuousGeneralizer_Load(object sender, EventArgs e)
        {
            ...
            var pDataRecords = new CDataRecords();
            //pDataRecords.ParameterInitialize.frmContinuousGeneralizer = this;
            ...
            CConstants.DataRecords = pDataRecords;
            CConstants.ParameterInitialize = pDataRecords.ParameterInitialize;
        ...
        private void mnuEMF_Click(object sender, EventArgs e)
        {
            //确定导出路径
            SaveFileDialog sfdjpg = new SaveFileDialog();
            //sfdjpg.Filter = "jpg files (*.jpg)|*.jpg|All files (*.*)|*.*";
        ...
        //private void TraverseAllPoints()
