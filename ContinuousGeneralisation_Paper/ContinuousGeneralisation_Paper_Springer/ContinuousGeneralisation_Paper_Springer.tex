...
\newcommand{\blndraft}{true}
%\newcommand{\blndraft}{false}
...
\begin{figure}[tb]
	\centering
	\includegraphics[draft=\blndraft]{ErosionBreak}
...
\begin{figure}[tb]
	\centering
	\includegraphics[draft=\blndraft]{ImaiIri_Shortcut}
...
\begin{figure}[tb]
	\centering
	\includegraphics[draft=false]{Shrink_Simplification}
...
\begin{figure}[tb]
	\centering
	\includegraphics[draft=false]{Shrink_Uniting}
...
comparing to themselves at the immediately previous steps.
To avoid this shrink, we unite a building with itself at the immediately 
previous 
step so that the 
