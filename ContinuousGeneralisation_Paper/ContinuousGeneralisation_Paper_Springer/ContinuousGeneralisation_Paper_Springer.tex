...
We generate goal map \mapg by generalizing \maps. 
...
\mapg when $t=1$, and that \maps is continuously
...
we merge them by introducing a bridge connecting the newarest points 
...
\subsection{Simplify merged buildings}
