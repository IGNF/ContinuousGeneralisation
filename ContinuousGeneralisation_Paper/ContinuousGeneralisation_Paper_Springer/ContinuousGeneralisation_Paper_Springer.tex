...
Studio 
2015) and ArcObjects SDK \revise{for the Microsoft .Net Framework}{}10.2. 
We ran our case study under 64-bit 
Windows 7 on a 3.3 GHz dual core CPU with 8 GB RAM.
%As ArcObjects SDK for the Microsoft .Net Framework 10.2 can 
%only  run under a 32-bit platform, we set a Post-build 
%event\footnote{The details of the setting can be found at 	
...
%so that we managed to use up to 3GM of RAM.
...
which means that \revise{we have}{there are $N=734$} regions.  
