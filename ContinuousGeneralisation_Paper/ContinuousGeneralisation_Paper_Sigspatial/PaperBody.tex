...
%	ylabel style={above left},
	...
	\legend{\quad $M=200{,}000$, \quad $M=400{,}000$}
	\end{axis}
	\end{tikzpicture}
	\caption{The numbers of regions where our approach was 
		...
		graph.}
	\label{fig:OverestimationStatistics}
\end{figure}
...
We produce a sequence of $10$ maps, which means $t \in \{0.1, 0.2, \dots, 1\}$.
...
A questionnaire, however, is needed to compare our result with the data.
