...
\todo{a shortcut is not allowed to intersect the building at the 
...
\begin{figure}[tb]
	...
	\caption{Some results for time $t=1$, at scale $1:50{,}000$.
		(a) Bridged buildings.
		(b) Goal shapes of the built-up areas, without removing small holes.
